      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl max-h-[90vh] overflow-y-auto glass-card shadow-2xl z-50 rounded-2xl"
          >
            {/* Header */}
            <div className="sticky top-0 bg-gradient-to-r from-[#111111] to-[#16a34a] p-6 rounded-t-2xl border-b border-[#16a34a]/20">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-3xl font-bold text-white flex items-center gap-3">
                    <Phone className="w-8 h-8" />
                    Talk to Fingent AI Agent
                  </h2>
                  <p className="text-gray-300 mt-2">Your professional financial advisor via phone call</p>
                </div>
                <button
                  onClick={onClose}
            ...
            <div className="p-6 space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-[#16a34a]/10 to-[#16a34a]/5 p-6 rounded-xl border border-[#16a34a]/20">
                    <h3 className="text-xl font-bold text-white mb-4">📞 Make Outbound Call</h3>
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-300 mb-2">{callResult.message}</p>
                            {callResult.call_sid && (
                              <p className="text-xs text-gray-400">Call SID: {callResult.call_sid}</p>
                            )}
                            {callResult.details && (
                              <div 
                  ...
                  {/* Agent Info */}
                  <div className="bg-gradient-to-br from-[#D4AF37]/10 to-[#D4AF37]/5 p-6 rounded-xl border border-[#D4AF37]/20">
                    <h4 className="text-lg font-bold text-white mb-3">🤖 Agent Details</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-gray-400">Name:</span>
                        <span className="text-white font-semibold">Fingent AI</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-400">Voice:</span>
                        <span className="text-white font-semibold">Professional Male</span>
                      </div>
                      <div className="flex justify-between">
                ...
                {/* Right: Features */}
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-white mb-4">🎯 Agent Features</h3>
                  {features.map((feature, index) => (
                    <motion.div
                      ...
                      className="bg-gray-800/50 p-4 rounded-lg border border-gray-700 hover:border-[#16a34a]/50 transition-colors"
                    >
                      <div className="flex items-start gap-3">
                        <feature.icon className="w-6 h-6 text-[#16a34a] flex-shrink-0" />
                        <div>
                  ...
                  {/* Info Box */}
                  <div className="bg-blue-900/20 p-4 rounded-lg border border-blue-500/30 mt-6">
                  ...
                  <div className="bg-yellow-900/20 p-4 rounded-lg border border-yellow-500/30">
                    <h4 className="font-bold text-yellow-300 mb-2">⚠️ Important Notice</h4>
                    <p className="text-sm text-gray-300">
            ...
            {/* Footer */}
            <div className="p-4 bg-gray-900/50 rounded-b-2xl border-t border-gray-800">
